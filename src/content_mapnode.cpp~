...
void content_mapnode_init()
{
	...
	i = CONTENT_WOOL;
	f = &content_features(i);
	f->setAllTextures("wool_white.png");
	f->setInventoryTextureCube("wool_white.png", "wool_white.png", "wool_white.png");
	f->is_ground_content = true;
	f->dug_item = std::string("MaterialItem2 ")+itos(i)+" 1";
	setWoodLikeDiggingProperties(f->digging_properties, 0.75);

	i = CONTENT_WOOL_LIGHT_GREY;
	f = &content_features(i);
	f->setAllTextures("wool_grey.png");
	f->setInventoryTextureCube("wool_grey.png", "wool_grey.png", "wool_grey.png");
	f->is_ground_content = true;
	f->dug_item = std::string("MaterialItem2 ")+itos(i)+" 1";
	setWoodLikeDiggingProperties(f->digging_properties, 0.75);

	i = CONTENT_WOOL_DARK_GREY;
	f = &content_features(i);
	f->setAllTextures("wool_dark_grey.png");
	f->setInventoryTextureCube("wool_dark_grey.png", "wool_dark_grey.png", "wool_dark_grey.png");
	f->is_ground_content = true;
	f->dug_item = std::string("MaterialItem2 ")+itos(i)+" 1";
	setWoodLikeDiggingProperties(f->digging_properties, 0.75);

	i = CONTENT_WOOL_BLACK;
	f = &content_features(i);
	f->setAllTextures("wool_black.png");
	f->setInventoryTextureCube("wool_black.png", "wool_black.png", "wool_black.png");
	f->is_ground_content = true;
	f->dug_item = std::string("MaterialItem2 ")+itos(i)+" 1";
	setWoodLikeDiggingProperties(f->digging_properties, 0.75);
	...
	i = CONTENT_WOOL_RED;
	f = &content_features(i);
	f->setAllTextures("wool_red.png");
	f->setInventoryTextureCube("wool_red.png", "wool_red.png", "wool_red.png");
	f->is_ground_content = true;
	f->dug_item = std::string("MaterialItem2 ")+itos(i)+" 1";
	setWoodLikeDiggingProperties(f->digging_properties, 0.75);

	i = CONTENT_WOOL_ORANGE;
	f = &content_features(i);
	f->setAllTextures("wool_orange.png");
	f->setInventoryTextureCube("wool_orange.png", "wool_orange.png", "wool_orange.png");
	f->is_ground_content = true;
	f->dug_item = std::string("MaterialItem2 ")+itos(i)+" 1";
	setWoodLikeDiggingProperties(f->digging_properties, 0.75);

	i = CONTENT_WOOL_YELLOW;
	f = &content_features(i);
	f->setAllTextures("wool_yellow.png");
	f->setInventoryTextureCube("wool_yellow.png", "wool_yellow.png", "wool_yellow.png");
	f->is_ground_content = true;
	f->dug_item = std::string("MaterialItem2 ")+itos(i)+" 1";
	setWoodLikeDiggingProperties(f->digging_properties, 0.75);

	i = CONTENT_WOOL_GREEN;
	f = &content_features(i);
	f->setAllTextures("wool_green.png");
	f->setInventoryTextureCube("wool_green.png", "wool_green.png", "wool_green.png");
	f->is_ground_content = true;
	f->dug_item = std::string("MaterialItem2 ")+itos(i)+" 1";
	setWoodLikeDiggingProperties(f->digging_properties, 0.75);

	i = CONTENT_WOOL_BROWN;
	f = &content_features(i);
	f->setAllTextures("wool_brown.png");
	f->setInventoryTextureCube("wool_brown.png", "wool_brown.png", "wool_brown.png");
	f->is_ground_content = true;
	f->dug_item = std::string("MaterialItem2 ")+itos(i)+" 1";
	setWoodLikeDiggingProperties(f->digging_properties, 0.75);
	...
	i = CONTENT_WOOL_CYAN;
	f = &content_features(i);
	f->setAllTextures("wool_cyan.png");
	f->setInventoryTextureCube("wool_cyan.png", "wool_cyan.png", "wool_cyan.png");
	f->is_ground_content = true;
	f->dug_item = std::string("MaterialItem2 ")+itos(i)+" 1";
	setWoodLikeDiggingProperties(f->digging_properties, 0.75);
	...
	i = CONTENT_WOOL_BLUE;
	f = &content_features(i);
	f->setAllTextures("wool_blue.png");
	f->setInventoryTextureCube("wool_blue.png", "wool_blue.png", "wool_blue.png");
	f->is_ground_content = true;
	f->dug_item = std::string("MaterialItem2 ")+itos(i)+" 1";
	setWoodLikeDiggingProperties(f->digging_properties, 0.75);

	i = CONTENT_WOOL_PURPLE;
	f = &content_features(i);
	f->setAllTextures("wool_purple.png");
	f->setInventoryTextureCube("wool_purple.png", "wool_purple.png", "wool_purple.png");
	f->is_ground_content = true;
	f->dug_item = std::string("MaterialItem2 ")+itos(i)+" 1";
	setWoodLikeDiggingProperties(f->digging_properties, 0.75);
	...
	i = CONTENT_WOOL_PINK;
	f = &content_features(i);
	f->setAllTextures("wool_pink.png");
	f->setInventoryTextureCube("wool_pink.png", "wool_pink.png", "wool_pink.png");
	f->is_ground_content = true;
	f->dug_item = std::string("MaterialItem2 ")+itos(i)+" 1";
	setWoodLikeDiggingProperties(f->digging_properties, 0.75);
