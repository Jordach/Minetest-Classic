...
InventoryItem *craft_get_result(InventoryItem **items)
{
	...
	{
		ItemSpec specs[9];
		specs[0] = ItemSpec(ITEM_MATERIAL, CONTENT_SAND);
		specs[1] = ItemSpec(ITEM_CRAFT, "lump_of_coal");
		if(checkItemCombination(items, specs))
		{
			return new MaterialItem(CONTENT_WOOL, 4);
		}
	}
	///
	{
		ItemSpec specs[9];
		specs[0] = ItemSpec(ITEM_MATERIAL, CONTENT_WOOL);
		specs[1] = ItemSpec(ITEM_CRAFT, "lump_of_coal");
		if(checkItemCombination(items, specs))
		{
			return new MaterialItem(CONTENT_WOOL_LIGHT_GREY, 4);
		}
	}
	///
	{
		ItemSpec specs[9];
		specs[0] = ItemSpec(ITEM_MATERIAL, CONTENT_WOOL_LIGHT_GREY);
		specs[1] = ItemSpec(ITEM_CRAFT, "lump_of_coal");
		if(checkItemCombination(items, specs))
		{
			return new MaterialItem(CONTENT_WOOL_DARK_GREY, 4);
		}
	}
	///
	{
		ItemSpec specs[9];
		specs[0] = ItemSpec(ITEM_MATERIAL, CONTENT_WOOL_DARK_GREY);
		specs[1] = ItemSpec(ITEM_CRAFT, "lump_of_coal");
		if(checkItemCombination(items, specs))
		{
			return new MaterialItem(CONTENT_WOOL_BLACK, 4);
		}
	}
	///
	{
		ItemSpec specs[9];
		specs[0] = ItemSpec(ITEM_MATERIAL, CONTENT_WOOL);
		specs[1] = ItemSpec(ITEM_CRAFT, "apple");
		if(checkItemCombination(items, specs))
		{
			return new MaterialItem(CONTENT_WOOL_RED, 4);
		}
	}
	///
	{
		ItemSpec specs[9];
		specs[0] = ItemSpec(ITEM_MATERIAL, CONTENT_WOOL);
		specs[1] = ItemSpec(ITEM_MATERIAL, CONTENT_SAND);
		if(checkItemCombination(items, specs))
		{
			return new MaterialItem(CONTENT_WOOL_YELLOW, 4);
		}
	}
	////
	{
		ItemSpec specs[9];
		specs[0] = ItemSpec(ITEM_MATERIAL, CONTENT_WOOL_RED);
		specs[1] = ItemSpec(ITEM_MATERIAL, CONTENT_WOOL_YELLOW);
		if(checkItemCombination(items, specs))
		{
			return new MaterialItem(CONTENT_WOOL_ORANGE, 4);
		}
	}
	///
	{
		...
		if(checkItemCombination(items, specs))
		{
			return new MaterialItem(CONTENT_WOOL_BROWN, 4);
		}
	}
	////
	{
		ItemSpec specs[9];
		specs[0] = ItemSpec(ITEM_MATERIAL, CONTENT_WOOL);
		specs[1] = ItemSpec(ITEM_MATERIAL, CONTENT_LEAVES);
		if(checkItemCombination(items, specs))
		{
			return new MaterialItem(CONTENT_WOOL_GREEN, 4);
		}
	}
	////
	{
		ItemSpec specs[9];
		specs[0] = ItemSpec(ITEM_MATERIAL, CONTENT_WOOL);
		specs[1] = ItemSpec(ITEM_MATERIAL, CONTENT_JUNGLETREE);
		if(checkItemCombination(items, specs))
		{
			return new MaterialItem(CONTENT_WOOL_CYAN, 4);
		}
	}
	////
	{
		ItemSpec specs[9];
		specs[0] = ItemSpec(ITEM_MATERIAL, CONTENT_WOOL_RED);
		specs[1] = ItemSpec(ITEM_MATERIAL, CONTENT_WOOL_CYAN);
		if(checkItemCombination(items, specs))
		{
			return new MaterialItem(CONTENT_WOOL_PURPLE, 4);
		}
	}
	////
	{
		ItemSpec specs[9];
		specs[0] = ItemSpec(ITEM_MATERIAL, CONTENT_WOOL_CYAN);
		specs[1] = ItemSpec(ITEM_MATERIAL, CONTENT_WOOL_PURPLE);
		if(checkItemCombination(items, specs))
		{
			return new MaterialItem(CONTENT_WOOL_BLUE, 4);
		}
	}
	////
	{
	...
	////
	{
		ItemSpec specs[9];
		specs[0] = ItemSpec(ITEM_MATERIAL, CONTENT_WOOL_RED);
		specs[1] = ItemSpec(ITEM_MATERIAL, CONTENT_WOOL);
		if(checkItemCombination(items, specs))
		{
			return new MaterialItem(CONTENT_WOOL_PINK, 4);
		}
	}
